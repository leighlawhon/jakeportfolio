...
test this post in your `_posts` *directory. Go ahead*{:.test} and edit it and re-build the site to see your changes. You can rebuild the<span class="inline"> site in many different ways</span>, but the most common way is to run `jekyll serve`, which launches a web server and auto-regenerates your site when a file is updated.
{:.para}
